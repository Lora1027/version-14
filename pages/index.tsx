...
type Tx = { id:string; date:string; type:'income'|'expense'; category:string|null; method:string|null; amount:number; notes:string|null }
...
function QuickAdd({ onSaved }:{ onSaved:()=>void }){
  ...
  return (
    <div className="row">
      ...
      <input value={category} onChange={e=>setCategory(e.target.value)} placeholder="Category" style={{minWidth:150}}/>
